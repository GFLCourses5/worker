...
//    private static final java.lang.String DEFAULT_ACTION = String.SLEEP.getName();
//    private static final java.lang.String DEFAULT_VALUE = "Default value";
//    private static final java.lang.String ANOTHER_ACTION = String.SLEEP.getName();;
//    private static final java.lang.String ANOTHER_VALUE = "Another value";
//
//    @Test
...
//        Step step = new Step();
//
//        step.setAction(String.valueOf(DEFAULT_ACTION));
...
//        return new Step(String.valueOf(DEFAULT_ACTION), DEFAULT_VALUE);
//    }
//
//    private Step prepareAnotherStep() {
//        return new Step(String.valueOf(ANOTHER_ACTION), ANOTHER_VALUE);
//    }
}